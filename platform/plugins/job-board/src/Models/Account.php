    ...
    CanResetPasswordContract
{
    ...
    public function purchasedConsultantPackages(): BelongsToMany
    {
        return $this->belongsToMany(ConsultantPackage::class, 'jb_account_jb_consultant_package', 'account_id', 'package_id');
    }

    /**
     * Get all of the consultantPackages for the Account
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function consultantPackages(): HasMany
    {
        return $this->hasMany(ConsultantPackage::class, 'consultant_id');
    }
    ...
    {
        return $this->hasMany(ConsultantReview::class, 'reviewed_user_id');
    }
